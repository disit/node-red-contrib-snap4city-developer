...
(function ($, undefined) {
	...
	$(document).ready(function () {
		...
		test("simple sequence", function () {
			...
			$testElement.simulate("key-sequence", {
				sequence: testSequence
			});
