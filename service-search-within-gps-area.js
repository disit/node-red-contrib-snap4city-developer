...
module.exports = function (RED) {
    ...
    function ServiceSearchWithinGpsArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=" + latitudebottomleft + ";" + longitudebottomleft + ";" + latitudetopright + ";" + longitudetopright + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json&fullCount=false" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
