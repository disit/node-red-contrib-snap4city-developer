...
module.exports = function (RED) {
    ...
    function ServiceSearchByMunicipality(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=COMUNE di " + municipality + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json&fullCount=false" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
