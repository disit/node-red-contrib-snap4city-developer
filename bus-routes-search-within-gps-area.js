...
module.exports = function (RED) {
    ...
    function BusRoutesSearchWithinGpsArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=" + latitudebottomleft + ";" + longitudebottomleft + ";" + latitudetopright + ";" + longitudetopright + "&agency=" + agency + "&maxResults=" + maxResults + "&format=json" + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
