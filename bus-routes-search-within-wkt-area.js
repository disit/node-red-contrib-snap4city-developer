...
module.exports = function (RED) {
    ...
    function BusRoutesSearchWithinWktArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=wkt:" + wktarea + "&agency=" + agency + "&maxResults=" + maxResults + "&format=json" + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
