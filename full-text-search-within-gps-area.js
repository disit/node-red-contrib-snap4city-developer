...
module.exports = function (RED) {
    ...
    function FullTextSearchWithinGpsArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?search=" + search + "&selection=" + latitudebottomleft + ";" + longitudebottomleft + ";" + latitudetopright + ";" + longitudetopright + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
