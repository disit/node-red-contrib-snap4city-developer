...
module.exports = function (RED) {
    ...
    function AddressPoiSearchByTextExp(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?search=" + search + "&searchMode=" + searchMode + "&excludePOI=" + excludePoi + "&maxResults=" + maxResults + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
