...
module.exports = function (RED) {
    ...
    function AddressPoiSearchByTextNearGpsPosition(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?search=" + search + "&position=" + latitude + ";" + longitude + "&searchMode=ANDOR" + "&excludePOI=false" + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
