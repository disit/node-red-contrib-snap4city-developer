...
module.exports = function (RED) {
    ...
    function BusRoutesSearchWithinStoredWktArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=geo:" + geoid + "&agency=" + agency + "&maxResults=" + maxResults + "&format=json" + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
